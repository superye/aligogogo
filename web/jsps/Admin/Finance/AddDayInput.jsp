...
<form action="admin_InsertDayInput.action" method="post" class="formstyle">

  <div class="row">
    <div class="col-lg-6">
      <label for="order_id">订单编号</label>
      <input type="text" class="form-control"  name="sdi.order_id" id="order_id" placeholder="订单编号">
    </div>
    <div class="col-lg-6">
      <label for="station_id">站点</label>
      <input type="text" class="form-control" id="station_id" name="sdi.station_id" placeholder="站点">
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
      <label for="payer_id">付款人ＩＤ</label>
      <input type="text" class="form-control" id="payer_id" name="sdi.payer_id" placeholder="付款人ＩＤ">
    </div>
    <div class="col-lg-6">
      <label for="time">日期</label>
      <input type="date" class="form-control" id="time" name="sdi.time" placeholder="年/月/日">
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
      <label for="type">类别</label>
      <input type="text" class="form-control" id="type" name="sdi.type" placeholder="类别">
    </div>
    <div class="col-lg-6">
      <label for="Pname">品名</label>
      <input type="text" class="form-control" id="Pname" name="sdi.Pname" placeholder="品名">
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
      <label for="pay_money">缴费金额</label>
      <input type="text" class="form-control" id="pay_money" name="sdi.pay_money" placeholder="支出金额">
    </div>
    <div class="col-lg-6">
      <label for="counter_Fee">手续费</label>
      <input type="text" class="form-control" id="counter_Fee" name="sdi.counter_Fee" placeholder="手续费">
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
      <label for="real_input">实际收入</label>
      <input type="text" class="form-control" id="real_input" name="sdi.real_input" placeholder="实际收入">
    </div>
    <div class="col-lg-6">
      <label for="balance">余额</label>
      <input type="text" class="form-control" id="balance" name="sdi.balance" placeholder="余额">
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
      <label for=" transaciton_type">交易类型</label>
      <input type="text" class="form-control" id=" transaciton_type" name="sdi.transaction_type" placeholder="交易类型">
    </div>
    <div class="col-lg-6">
      <label for="has_invoice">有无发票</label>
      <input type="text" class="form-control" id="has_invoice" name="sdi.has_invoice" placeholder="有无发票">
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
      <label for="person_in_charge">经手人ＩＤ</label>
      <input type="text" class="form-control" id="person_in_charge" name="sdi.person_in_charge" placeholder="经手人ＩＤ">
    </div>

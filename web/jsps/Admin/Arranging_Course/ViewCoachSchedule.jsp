...
<div id="second">
  <ul class="nav nav-tabs" role="tablist">
    <li><a href="admin_LoadCoachCourse.action">师资安排</a></li>
    <li><a href="admin_GetStudentSchedule.action">查看学生课表</a></li>
    <li class="active"><a href="#">查看Coach课表</a></li>
    <li><a href="admin_GetFeedback.action">查看反馈</a></li>
  </ul>
</div>
...
<div class="tab-pane">
  ...
  <div id="second2">
    <form class="form-inline" action="admin_GetCoachSchedule.action">
  ...
  <div id="table1" class="table-responsive clearfix">
    <font style="font-weight: bold">Coach姓名 ： ${name}</font>
    <table class="table table-bordered ">
      <thead>
      <tr>
        <th class="time-sort"></th>
        <th class="week"><div style="width: 105px">星期一/Mon</div></th>
        <th class="week">星期二/Tue</th>
        <th class="week"><div style="width: 105px">星期三/Wed</div></th>
